    ...
    return (
        <>
            ...
            <div className=" mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
                <div>my name is <span className="font-bold">Sk Naimuddin</span> ,</div>
                <div className="font-normal ml-1">I'm a <span className="text-pink-600 font-bold">Hotelier.</span></div>
            </div>
            ...
            <ul className=" mt-4 leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
                <li className=" list-pc">I'm a <span className="font-medium">from Gurunanak Institute of Hotel Management (GNIHM).( Contact me up <a className='text-underline' href='mailto:sknaimuddin234@gmail.com'><u>sknaimuddin234@gmail.com</u></a> :) )</li>
            ...
            <ul className=" w-10/12  mt-4 ml-4 px-0 md:px-1">
                <li className="list-disc">
                    <div className=" text-lg md:text-xl text-left font-bold leading-tight">
                        Gurunanak Institute of Hotel Management - GNIHM
                    </div>
                    <div className=" text-sm text-gray-400 mt-0.5">2019 - 2022</div>
                    <div className=" text-sm md:text-base">B.sc in Hospitality and Hotel Administration</div>
                    <div className="text-sm text-gray-300 font-bold mt-1">CGPA &nbsp; </div>
                </li>
                <li className="list-disc mt-5">
                    <div className=" text-lg md:text-xl text-left font-bold leading-tight">
                        Class 12<sup>th</sup> (Barisha High School)
                    </div>
        ...
        <>
            ...
            <ul className=" tracking-tight text-sm md:text-base w-10/12 emoji-list">
                <li className=" list-arrow text-sm md:text-base mt-4 leading-tight tracking-tight">
                    Basic knowledge about Alcoholic Beverages, types of services and guest handlings.
                </li>
                <li className=" list-arrow text-sm md:text-base mt-4 leading-tight tracking-tight">
                    <div> Handling <strong className="text-ubt-gedit-orange">Interns, Casual, OJT. Also teach and brief them about the functionality of the industry.</strong></div>
                </li>
                <li className=" list-arrow text-sm md:text-base mt-4 leading-tight tracking-tight">
                    <div>Being a great team member and handle small-medium operations in absence of supervisor.</div>
                </li>
                <li className=" list-arrow text-sm md:text-base mt-4 leading-tight tracking-tight">
                    <div>Listen to my team members and try to create a fun work environment with jokes, sarcasm and humors.</div>
                </li>
            </ul>
        </>
    )
